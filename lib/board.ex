defmodule Oca.Board do
  ...
  defstruct pot: 0, 
    spaces: [ 
      ...
      %Oca.Space{number: 5, name: "Goose", player: nil, event: {:goose} },
      %Oca.Space{number: 6, name: "Bridge", player: nil, event: {:goto, 12} },
      %Oca.Space{number: 7, name: "", player: nil, event: {} },
      %Oca.Space{number: 8, name: "", player: nil, event: {} },
      %Oca.Space{number: 9, name: "Goose", player: nil, event: {:goose} },
      ...
      %Oca.Space{number: 14, name: "Goose", player: nil, event: {:goose} },
      ...
      %Oca.Space{number: 18, name: "Goose", player: nil, event: {:goose} },
      %Oca.Space{number: 19, name: "Inn", player: nil, event: {:lose_turn, 1} },
      ...
      %Oca.Space{number: 23, name: "Goose", player: nil, event: {:goose} },
